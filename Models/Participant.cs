...
namespace CompetitionApp.Models
{
    public class Participant
    {
        ...
        public decimal CalculateTotalTime()
        {
            ...
            decimal penalties = (AlfaCount * config.AlfaValue) +
                               (BravoCount * config.BravoValue) +
        ...
        // Propriedade para compatibilidade com as views
        public decimal TotalTime => CalculateTotalTime();
